...
<html>
	...
	<body>
		...
		<div class="main">
			<div class="v"></div>
			<form action="${pageContext.request.contextPath }/addCar.action" method="post" enctype="multipart/form-data">
				<div class="f_div1">
					...
					<div class="new_input_info">
						<input type="radio" name="subject" value="科目二" /><span>科目二</span>
						<input type="radio" name="subject" value="科目三" /><span>科目三</span>
					</div>
					<div class="new_text_info clearfix">
						<span>项目：</span>
					</div>
